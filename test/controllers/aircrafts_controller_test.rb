...
class AircraftsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aircraft" do
    assert_difference("Aircraft.count") do
      post aircrafts_url, params: { aircraft: { engine: @aircraft.engine, make: @aircraft.make, model: @aircraft.model } }
    end
  ...
  test "should update aircraft" do
    patch aircraft_url(@aircraft), params: { aircraft: { engine: @aircraft.engine, make: @aircraft.make, model: @aircraft.model } }
